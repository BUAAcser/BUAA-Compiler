...
public class GreatEqual implements Ir {
    private String left;
    private String operand1;
    private String operand2;

    public GreatEqual(String left, String operand1, String operand2) {
        this.left = left;
    ...
    public void generate(ArrayList<String> mips, HashMap<String, Integer> varOffset,
        ...
        String result = "sge " + resReg + ", " + leftReg + ", "  + rightReg + "   #"  + this.toString();
        mips.add(result);
